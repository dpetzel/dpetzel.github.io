...
.. NOTE::
	It was pointed out to me that while ZenPacks are technically eggs,
...
I recently had the need to update the `F5 ZenPack`_. It had been a while since
...
but rather show what I think is a better (more automatted) solution.
...
So I set out on the road of using `Travis CI`_ uploading `PyPi`_. So the first
...
The `Travis CI`_ getting started documentation is pretty indepth, so I don't want
...
the encrypted environment variable stuff), I ended up with this `.travis.yml`_.

So now everytime I push a change up to the github repo, a service hook fires
and `Travis CI`_ starts building my ZenPack immediatly. You can see those build
...
.. _F5 ZenPack: https://github.com/ZCA/ZenPacks.community.f5
.. _Travis CI: https://travis-ci.org
.. _PyPi: http://pypi.python.org
.. _.travis.yml: https://github.com/ZCA/ZenPacks.community.f5/blob/master/.travis.yml
