...
So I I updated my ``get_db_prep_value`` as follows.
Old:
...
``{% url myproject.myapp.views.someview arg1%}`` and I had to change those to
``{% url "myproject.myapp.views.someview" arg1%}``.
